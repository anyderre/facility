...
export class ResidentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.residentService
      ...
      .subscribe(
        (res: HttpResponse<IResident[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInResidents(): void {
    this.eventSubscriber = this.eventManager.subscribe('residentListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IResident[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

...
public class FacilityResource {
    ...
    public FacilityResource(FacilityRepository facilityRepository, UserRepository userRepository) {
    ...
    public ResponseEntity<Facility> createFacility(@Valid @RequestBody Facility facility, Principal principal) throws URISyntaxException {
        ...
        user.ifPresent(facility::setUser);
        facility.creationDate(Instant.now());
        facility.modificationDate(Instant.now());
    ...
    public ResponseEntity<List<Facility>> getAllFacilities(Pageable pageable) {
        ...
        Page<Facility> page = facilityRepository.findByUserIsCurrentUser(pageable);
